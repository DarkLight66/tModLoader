...
namespace Terraria.ModLoader
{
	...
	public abstract class GlobalProjectile : GlobalType<Projectile>
	{
		...
		/// <summary>
		/// Allows you to determine the color and transparency in which a projectile is drawn. Return null to use the default color (normally light color after applying projectile.alpha). Returns null by default.
		/// </summary>
		/// <param name="projectile"> The projectile. </param>
